...
def obtain_evaluation_args():
    ...
    parser.add_argument('--whu2new_tagil', type=int, default=0, help='Transfer learning from whu to tagil?')
    parser.add_argument('--z_shift', type=int, default=0, help='prediction disparity shift')
